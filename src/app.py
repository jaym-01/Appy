...
def create_app() -> QApplication:
    """The QApplication, set up the way Hudzen wants it: name, taskbar identity, icon."""
    app = QApplication(sys.argv)
    app.setApplicationName("Hudzen")
    if sys.platform == "win32":
        ...
        ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID("Hudzen.Desktop")
