...
GOOD = {"name": "HudzenSetup.exe", "browser_download_url": f"{update._DOWNLOADS}v9.0.0/HudzenSetup.exe"}
...
class UpdateCheckTest(unittest.TestCase):
    ...
    def test_asset_outside_this_repo_is_ignored(self):
        bad = dict(GOOD, browser_download_url="https://example.com/HudzenSetup.exe")
